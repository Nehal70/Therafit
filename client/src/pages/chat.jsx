    ...
    try {
      ...
      if (data.exercise && data.exercise.name && data.exercise.name !== "N/A") {
        setMessages((prev) => [
          ...
          {
            id: Date.now() + 1,
            text: removeExerciseDetails(data.botMessage.text),
            sender: "bot",
          },
        ]);
        ////
    ...
    <>
      ...
      {exercise && (
        <div className="mt-4 p-3 bg-gray-100 border rounded-lg">
          <h3 className="font-bold text-xl mb-2">🏋️ Recommended Workout:</h3>
          <p>
            ...
            <div>
              ...
              <div className="flex flex-col max-w-xl m-auto pb-10 items-center">
                <h3 className="text-md mb-3">
                  Let&rsquo;s create a workout that supports your recovery and
                  goals!
                </h3>

                <p className="text-sm mb-3 text-center w-full text-fit-gray">
                  <em>
                    What injury (or injuries) are you currently dealing with?
                    <br />
                    How severe is it? (Mild discomfort, moderate pain, or
                    severe?)
                    <br />
                    What&rsquo;s your goal today? (Strength, mobility,
                    flexibility, pain relief, etc.)
                    <br />
