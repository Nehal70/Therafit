        ...
        <>
            <div className='flex'>
                ...
                <div className="chatbot bg-white p-4 max-w-2xl mx-auto mt-10 rounded-xl shadow-lg">
                    ...
                    <div className="chat-window h-[67vh] overflow-y-auto px-4">
                        <div>
                            <div className='bg-fit-orange max-w-[90px] p-5 rounded-full mx-auto mb-3'><img className='w-full' src={BotIcon} /></div>
