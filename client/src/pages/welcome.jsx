        ...
        <>
            <div className='flex flex-col max-w-[1100px] m-auto py-10 items-start'>
                ...
                <a href='dashboard' className='self-end'>
                    <button className='flex text-white justify-center items-center font-semibold bg-fit-orange rounded-[100px] px-6 py-2 hover:bg-fit-orange-hover hover:text-fit-white-hover'>Create Workout &nbsp;<BiSend size={28} /></button>
                </a>
