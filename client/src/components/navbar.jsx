    ...
    <>
      <div className='sticky top-0 bg-white flex items-center justify-between border-b px-5 py-3 border-gray-300'>
        ...
        <div className='flex gap-4 justify-center align-middle'>
          <button className='border border-[#1E1E1E] text-[#1E1E1E] px-5 py-2 rounded-[100px]'>Sign Up</button>
          <a href='#'><button className='bg-fit-orange px-5 py-2 rounded-[100px]'>Log In</button></a>
        </div>
      </div>
    </>
  );
